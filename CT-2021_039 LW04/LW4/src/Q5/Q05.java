...
public class Q05 {
    public static void main(String[] args) {
        ...
        System.out.println("\t 3.Bufffalo Wings - $3.99");
        System.out.println("\t 4.Rainbow Fillet - $2.9\n9");
        ...
        System.out.println("\t 9.Cafe Mocha - $1.49");
        ...
        if (side == 5) {
            ...
            System.out.println("you selected entree as No-Salt Fries");
            total = total + 0.69;
        } else if (side == 7) {
            System.out.println("you selected entree as Zucchini");
            total = total + 1.69;

        } else if (side == 8) {
            System.out.println("you selected entree as Brown Rice");
            total = total + 0.59;
        }
        if (drink == 9) {
